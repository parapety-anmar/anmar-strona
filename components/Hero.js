...
export default function Hero() {
  return (
    <>
      <section>
        <header className="relative lg:h-[750px] bg-red-600 lg:bg-transparent lg:bg-[url('/bg.webp')] bg-cover bg-no-repeat bg-center">
        ...
        <div className="container max-w-xs md:max-w-2xl lg:max-w-6xl mx-auto mt-5 lg:-mt-48">
          ...
          <h4 className="my-2 text-lg text-gray-500 font-semibold mt-3">
